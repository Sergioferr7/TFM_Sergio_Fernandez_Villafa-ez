...
team_name = st.text_input("Por favor, introduzca el nombre del equipo: ",key='input3').strip().lower()
position = st.text_input("Por favor, introduzca la posición a estudiar (ej. delantero, mediocampista, etc.): ",key='input4').strip().lower()
